...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-[#384331] text-white flex flex-col">
      ...
      <ul class="space-y-4 font-medium flex-1">
         ...
         <li>
            <a href="Reslist" class="flex items-center p-2 rounded-lg hover:bg-[#5A7A46] group">
               <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
               ...
               <span class="ms-3">Certificate/Clearance</span>
            </a>
         </li>
         <li>
    <a href="Officials" class="flex items-center p-2 rounded-lg hover:bg-[#5A7A46] group">
        <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
<li>
    <a href="List" class="flex items-center p-2 rounded-lg hover:bg-[#5A7A46] group">
        <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
