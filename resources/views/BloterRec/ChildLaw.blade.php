...
<body class="bg-gray-50 min-h-screen flex font-sans antialiased">
    ...
    <div class="flex-1 ml-64">
        <!-- Header Section -->
        <header class="fixed top-0 left-64 w-[calc(100%-16rem)] h-20 bg-gradient-to-r from-[#2d6a4f] to-[#1f4b38] text-white flex items-center px-6 shadow-md z-50">
            ...
            <div class="w-full max-w-7xl mx-auto">
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-8 bg-gray-50">
                        <x-ChildLaw class="w-full"></x-ChildLaw>
                    </div>
                </div>
            </div>
        </main>
