...
class FamilyMemberController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        // Safely handle birth_date
        $birthDate = '';
        if ($famMember->birth_date) {
            try {
                $birthDate = Carbon::parse($famMember->birth_date)->format('Y-m-d');
            } catch (\Exception $e) {
                Log::warning('Invalid birth_date for member ID: ' . $id . ', value: ' . $famMember->birth_date);
                $birthDate = $famMember->birth_date; // Fallback to raw value
            }
        }
