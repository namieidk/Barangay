...
<head>
    ...
    :root {
        ...
        --light-bg: #f8f9fa;
        --text-light: #ffffff; /* Used for button text */
        --text-dark: black; /* Default text color */
        --border-color: #dee2e6;
    ...
    * {
    ...
    body {
        ...
        min-height: 100vh;
        display: flex;
        color: var(--text-dark); /* All text defaults to black */
        line-height: 1.6;
    }
    ...
    .header {
        ...
        color: var(--text-dark); /* Header text black */
        border-radius: 8px;
        padding: 1rem 2rem;
    ...
    .header h1 {
        ...
        color: var(--text-dark); /* Explicitly black */
    }
    ...
    .search-container input {
        ...
        color: var(--text-dark); /* Input text black */
    }
    ...
    .search-icon {
        ...
        color: #6c757d; /* Keep search icon as is */
    }
    ...
    .doc-icon {
        background-color: rgb(132, 177, 132);
        width: 48px;
        height: 48px;
        border-radius: 50%;
        display: flex;
    ...
    .doc-title h2 {
        ...
        color: var(--text-dark); /* Title black */
    }

    .doc-title p {
        font-size: 0.9rem;
        opacity: 0.8;
        color: var(--text-dark); /* Subtitle black */
    }
    ...
    .document-details h3 {
        font-size: 1.1rem;
        color: var(--text-dark); /* Section header black */
        margin-bottom: 1rem;
        font-weight: 600;
    ...
    .info-list li {
        ...
        font-size: 0.95rem;
        color: var(--text-dark); /* List items black */
    }

    .info-list li svg {
        margin-right: 0.75rem;
        color: var(--text-dark); /* Icons black */
        flex-shrink: 0;
    }
    ...
    .form-label {
        font-size: 0.875rem;
        color: var(--text-dark); /* Labels black */
    ...
    .form-control {
        ...
        color: var(--text-dark); /* Form input text black */
    }
    ...
    .btn {
        ...
        letter-spacing: 0.5px;
        color: var(--text-light); /* Button text white */
    }
    ...
    th, td {
        ...
        text-align: left;
        font-size: 0.9rem;
        color: var(--text-dark); /* Table text black */
    }

    th {
        background-color: var(--light-bg);
        font-weight: 600;
        color: var(--text-dark); /* Table header black */
        text-transform: uppercase;
        letter-spacing: 0.5px;
        border-bottom: 2px solid var(--primary-light);
    }
    ...
    td .status-pending {
        ...
        color: #856404; /* Keep status colors as is */
    }
    ...
    .badge-certificate {
        ...
        color: #0070a8; /* Keep badge colors as is */
    }
    ...
    .btn-icon {
        ...
        color: var(--text-dark); /* Icon button text/icons black by default */
        transition: all 0.3s ease;
        border: 1px solid var(--border-color);
    }
    ...
    .btn-icon:hover {
        background-color: var(--primary-light);
        color: var(--text-light); /* White text/icons on hover */
    ...
    .alert-success {
        background-color: #d4edda;
        color: #155724; /* Keep alert colors as is */
    ...
    .no-data {
        text-align: center;
        padding: 2rem;
        color: var(--text-dark); /* No-data text black */
        font-size: 1rem;
        font-style: italic;
    }
    ...
    @media (max-width: 768px) {
        ...
        th, td {
            padding: 0.75rem;
            font-size: 0.85rem;
            color: var(--text-dark); /* Ensure table text remains black */
        }
    }
</style>
</head>
