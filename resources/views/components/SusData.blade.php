...
<body>
<div class="w-[1124px] ml-0  bg-[#77a659] " style="height: 700px;">
    <form class="ml-4 " >
        <div class="text-left " >
        ...
        <div class="text-left mt-4">
            <div class="inline-block mr-[50px]">
            <label for="date-time-reported" class="block whitespace-nowrap">Date & Time Reported<span class="text-red-500">*</span>
            <input type="datetime-local" id="date-time-reported" name="date-time-reported" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 230px">
            </div>
            <div class="inline-block mr-[50px]">
            <label for="date-time-incident" class="block whitespace-nowrap">Date & Time of Incident<span class="text-red-500">*</span>
            <input type="datetime-local" id="date-time-incident" name="date-time-incident" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 230px">
            </div>
            <div class="inline-block mr-[50px]">
            <label for="highest-education" class="block whitespace-nowrap">Highest Educational Attainment<span class="text-red-500">*</span>
            <input type="text" id="highest-education" name="highest-education" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 200px">
            </div>
            <div class="inline-block mr-[50px]">
            <label for="job-occupation" class="block whitespace-nowrap">Occupation<span class="text-red-500">*</span>
            <input type="text" id="job-occupation" name="job-occupation" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 170px">
            </div>
        </div>
        ...
        <div class="text-left mt-4">
            ...
            <input type="text" id="email-address" name="email-address" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 170px">
            </div>
            <div class="inline-block mr-[50px]">
            <label for="civil-status" class="block whitespace-nowrap">Civil Status<span class="text-red-500">*</span>
            <input type="text" id="civil-status" name="civil-status" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 170px">
            </div>
            <div class="inline-block mr-[50px]">
            <label for="relation-to-victim" class="block whitespace-nowrap">Relation to the Victim<span class="text-red-500">*</span>
            <input type="text" id="relation-to-victim" name="relation-to-victim" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 170px">
            </div>
            <div class="inline-block mr-[50px]">
            <label for="height-cm" class="block whitespace-nowrap">Height(Cm)<span class="text-red-500">*</span>
            <input type="text" id="height-cm" name="height-cm" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 170px">
            </div>
            <div class="inline-block mr-[50px]">
            <label for="weight-kg" class="block whitespace-nowrap">Weight(Kg)<span class="text-red-500">*</span>
            <input type="text" id="weight-kg" name="weight-kg" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 160px">
            </div>
        </div>

        <div class="text-left mt-4">
            <div class="inline-block mr-[50px]">
            <label for="eye-color" class="block whitespace-nowrap">Color Of The Eye<span class="text-red-500">*</span>
            <input type="text" id="eye-color" name="eye-color" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 160px">
            </div>
            <div class="inline-block mr-[50px]">
            <label for="eye-description" class="block whitespace-nowrap">Description Of Eye<span class="text-red-500">*</span>
            <input type="text" id="eye-description" name="eye-description" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 170px">
            </div>
            <div class="inline-block mr-[50px]">
            <label for="hair-color" class="block whitespace-nowrap">Color Of The Hair<span class="text-red-500">*</span>
            <input type="text" id="hair-color" name="hair-color" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 170px">
            </div>
            <div class="inline-block mr-[50px]">
            <label for="hair-description" class="block whitespace-nowrap">Description Of The Hair<span class="text-red-500">*</span>
            <input type="text" id="hair-description" name="hair-description" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 170px">
            </div>
            <div class="inline-block mr-[50px]">
            <label for="influence" class="block whitespace-nowrap">Under the Influence of?<span class="text-red-500">*</span>
            <input type="text" id="influence" name="influence" class="block border-b border-[#000000] bg-white outline-none text-[#000000]" style="width: 160px">
            </div>
        </div>
