...
<body class="bg-gray-100 min-h-screen flex font-sans antialiased">
                                    ...
                                    <tbody>
                                        @foreach($victims as $victim)
                                            <tr>
                                                ...
                                                <td>{{ $victim->type_of_incident }}</td>
                                                <td>{{ $victim->reportingPerson->first_name ?? 'N/A' }} {{ $victim->reportingPerson->last_name ?? '' }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                            </div>
                        @elseif(isset($victims))
                            <div class="search-results">
                                <p>No matching victim data found.</p>
                            </div>
                        @endif
    ...
    <select id="citizenship" name="citizenship" class="form-control" required>
        <option value="" {{ old('citizenship') == '' ? 'selected' : '' }}>Select country</option>
        ...
        <option value="Congo, Democratic Republic of the" {{ old('citizenship') == 'Congo, Democratic Republic of the' ? 'selected' : '' }}>Congo, Democratic Republic of the</option>
        <option value="Congo, Republic of the" {{ old('citizenship') == 'Congo, Republic of the' ? 'selected' : '' }}>Congo, Republic of the</option>
        ...
        <option value="Thailand" {{ old('citizenship') == 'Thailand' ? 'selected he' : '' }}>Thailand</option>
                            ...
                            <div class="step-content" data-step="3">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="barangay" name="barangay" class="form-control" value="{{ old('barangay', 'Barangay Incio') }}" required>
                                        @error('barangay')
                                            <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="town_city" name="town_city" class="form-control" value="{{ old('town_city', 'Incio City') }}" required>
                                        @error('town_city')
                                            <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="province" name="province" class="form-control" value="{{ old('province', 'Incio Province') }}" required>
                                        @error('province')
                                            <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="postal_code" name="postal_code" class="form-control" value="{{ old('postal_code', '9800') }}">
                                        @error('postal_code')
                                            <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const dateTimeReportedInput = document.getElementById('date_time_reported');

            let currentStep = 1;
            const totalSteps = steps.length;

            // Set default value for Date & Time Reported to current date and time
            if (!dateTimeReportedInput.value) {
                const now = new Date();
                ...
                dateTimeReportedInput.value = `${year}-${month}-${day}T${hours}:${minutes}`;
            }
