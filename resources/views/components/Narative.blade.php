...
<div class="w-[1124px] ml-0  bg-[#77a659] " style="height: 550px;">
    <form class="ml-4 " >
        <div class="text-left mb-10" >
            ...
            <div class="inline-block mr-[50px]">
            <label for="date-time" class="block whitespace-nowrap">Date & Time<span class="text-red-500">*</span>
            ...
            <div class="inline-block mr-[50px]">
            <label for="place-of-incident" class="block whitespace-nowrap">Place of Incident<span class="text-red-500">*</span>
        ...
        <div class="text-left">
            <div class="inline-block mr-[50px]">
                <label for="message" class="block mb-2 text-mg font-medium text-gray-900">Enter the detail the narrative of the incident or event, answering the WHO, WHAT, WHEN, WHERE, WHY, and HOW of reporting.<span class="text-red-500">*</span>
