...
<body>
<div class="w-[1124px] ml-0  bg-[#5A7A46] " style="height: 700px;">
    <form class="ml-4 " >
        <div class="text-left " >
        ...
        <div class="text-left mt-4">
            <div class="inline-block mr-[50px]">
            <label for="date-time-reported" class="block whitespace-nowrap">Date & Time Reported</label>
            ...
            <div class="inline-block mr-[50px]">
            <label for="date-time-incident" class="block whitespace-nowrap">Date & Time of Incident</label>
            ...
            <div class="inline-block mr-[50px]">
            <label for="highest-education" class="block whitespace-nowrap">Highest Educational Attainment</label>
            ...
            <div class="inline-block mr-[50px]">
            <label for="job-occupation" class="block whitespace-nowrap">Occupation</label>
        ...
        <div class="text-left mt-4">
            ...
            <div class="inline-block mr-[50px]">
            <label for="relation-to-victim" class="block whitespace-nowrap">Relation to the Victim</label>
            ...
            <div class="inline-block mr-[50px]">
            <label for="height-cm" class="block whitespace-nowrap">Height(Cm)</label>
            ...
            <div class="inline-block mr-[50px]">
            <label for="weight-kg" class="block whitespace-nowrap">Weight(Kg)</label>
        ...
        <div class="text-left mt-4">
            <div class="inline-block mr-[50px]">
            <label for="eye-color" class="block whitespace-nowrap">Color Of The Eye</label>
            ...
            <div class="inline-block mr-[50px]">
            <label for="eye-description" class="block whitespace-nowrap">Description Of Eye</label>
            ...
            <div class="inline-block mr-[50px]">
            <label for="hair-color" class="block whitespace-nowrap">Color Of The Hair</label>
            ...
            <div class="inline-block mr-[50px]">
            <label for="hair-description" class="block whitespace-nowrap">Description Of The Hair</label>
            ...
            <div class="inline-block mr-[50px]">
            <label for="influence" class="block whitespace-nowrap">Under the Influence of?</label>
